...
/* Gestión de Fila de Espera (Shift y Unshift)
...
function filaEspera() {
    ...
    let clase = [alumnos.shift()]
    alert(`Entró ${clase[0]} y la fila ahora es: ${alumnos.join(", ")}.`);
}
...
function limpiezaDatos() {
    ...
    let eliminado = [inventario.shift(), inventario.pop()]
